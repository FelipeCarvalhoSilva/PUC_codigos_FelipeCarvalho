...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /* String teste="a";
        String teste2="b";
        if (teste.compareTo(teste2) > 0) {
            System.out.println(teste + " vem depois de " + teste2);
        } else if (teste.compareTo(teste2) < 0) {
            System.out.println(teste + " vem antes de " + teste2);
        } else {
            System.out.println(teste + " é igual a " + teste2);
        } */
