...
public class Main {
  public static void main(String[] args) {
    ...
    while (!input.equals("FIM")) {
      ...
      if (!input.equals("FIM")) {
        ...
        String resp3;
        String resp4;
        if (eVogal(input, 0) == true)
          resp1 = "SIM";
        else
          resp1 = "NAO";

        if (eConsoante(input,0) == true)
          resp2 = "SIM";
        else
          resp2 = "NAO";

        if (eInteiro(input, 0) == true)
          resp3 = "SIM";
        else
          resp3 = "NAO";

        if (eReal(input,0) == true)
          resp4 = "SIM";
        else
          resp4 = "NAO";
  ...
  // vogal
  public static boolean eVogal(String input, int n) {

    if (n >= input.length())
      return true;
    char currentChar = Character.toLowerCase(input.charAt(n));

    if (currentChar != 'a' && currentChar != 'e' && currentChar != 'i' && currentChar != 'o' && currentChar != 'u')
      return false;

    return eVogal(input, n + 1);
  }

  // consoante
  public static boolean eConsoante(String input, int n) {
    if (n >= input.length())
      return true;
    char currentChar = Character.toLowerCase(input.charAt(n));
    ...
    return eConsoante(input, n + 1);
  }

  // inteiro
  public static boolean eInteiro(String input, int n) {
    if (n >= input.length())
      return true;
    char currentChar = input.charAt(n);
    if (!(currentChar >= '0' && currentChar <= '9'))
      return false;
    return eInteiro(input, n + 1);
  }

  // real
  public static boolean eReal(String input,int x) {
    if (x>=input.length())return true;
    int n = 0;
